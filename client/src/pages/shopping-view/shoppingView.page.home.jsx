...
import { SiAdidas, SiLiberadotchat, SiLiberapay, SiNike, SiPuma, SiZara } from "react-icons/si";
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className='py-12 bg-gray-50'>
                <div className='container mx-auto px-4'>
                    ...
                    <div className={`grid grid-cols-2 md:grid-cols-3 ${brandsWithIcon.length % 2 !== 0 ? 'lg:grid-cols-4' : 'lg:grid-cols-6'} gap-4`}>
                        {
