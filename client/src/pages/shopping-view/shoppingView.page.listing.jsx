import ProductFilter from "@/components/shopping-view/shoppingView.comp.filter";
...
import { sortOptions } from "@/config/config.index";
import { addToCart, fetchCartItems } from "@/store/shop/cart-slice/cart-slice.shop.index";
import {
  fetchAllFilteredProducts,
  fetchProductDetails,
} from "@/store/shop/product-slice/product-slice.shop.index";
    ...
    <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-6 p-4 md:p-6">
      ...
      <div className="bg-background w-full rounded-lg shadow-sm">
        <div className="p-4 border-b flex items-center justify-between">
          <h2 className="bg-background font-extrabold">All Products</h2>
